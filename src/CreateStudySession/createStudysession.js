...
class CreateStudySession extends Component {
  ...
  componentDidMount(){
    ...
    let dateToday = this.getDateOfToday();
    this.setState({
      startTime: new Date(dateToday + 'T' + "09:00" + ':00'),
      endTime: new Date(dateToday + 'T' + "09:00" + ':00'),
...
getDateOfToday(){
  ...
  // sets start time based on parameter
          ...
          <div className="studySessionParameters">
            <div className="div-parameter">
              ...
              <div className="timeBoxes">
                ...
                <input type="date" id="sessionDate" name="sessionDate" className="sessionDate" defaultValue={today} min={today} max="2020-12-31" 
                  onChange={e => this.setState({sessionDate: e.target.value})}/> <br/>
              ...
              <div className="studysession-description">
                ...
                <textarea className="description-box" placeholder="Description of study session, for example course code, group room" 
                  onChange={e => this.setState({description: e.target.value})} id="description" rows="5" cols="100">
                </textarea><br/>
              </div>
